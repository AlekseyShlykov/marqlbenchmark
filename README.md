...
- `assets/benchmark-data.json` contains the four v3 model rows from the public report of 19 September 2026, fetched on 23 September 2026. All use the MARQL system and weekly reviews, with five evaluation seeds per world.
